...
Welcome to the Tile Server API for `map.lamangintel.net`. This API serves map tiles based on coordinates and provides access to tile data stored. Please read through the documentation before using the API.

## Base URL

```plaintext
https://tiles.map.lamangintel.net
```
...
**Response**:
- `200 OK` with the message: `Tile server for map.lamangintel.net`
...
**Email**: [info@map.lamangintel.net](mailto:info@map.lamangintel.net)
